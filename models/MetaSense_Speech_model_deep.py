...
feature_flatten_dim = 7680  # 128 len
input_channel_dim = 1
...
class MAML_BN(nn.Module):
    ...
    def __init__(self, opt):
        ...
        conv6 = nn.Conv1d(128, 256, kernel_size=6, stride=2)
        bn6 = nn.BatchNorm1d(256)
        conv7 = nn.Conv1d(256, 512, kernel_size=6, stride=2)
        ...
        fc4 = nn.Linear(256, self.opt['num_class'])
